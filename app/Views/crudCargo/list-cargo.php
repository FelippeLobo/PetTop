  ...
  <body>
    <div class="container cont-lista">
      <div class="form-row buttonadd">
        <h1>Cargos</h1>
        <a href="add-cargo.html"><button type="button" class="btn btn-primary">+ Adicionar um cargo</button></a>
      </div>
      <table class="table table-striped lista-in">
          ...
          <tbody>
            <tr>
                ...
                <a href="edit-cargo.html"><button type="button" class="btn btn-warning" href="">Editar</button></a>
