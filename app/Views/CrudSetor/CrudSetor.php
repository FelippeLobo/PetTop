...
<body>
            ...
            <div class="container">
                        <div class="row cabeçalho">
                            ...
                            <a class="btn btn-primary col-md-2 col-2 cliente d-none d-sm-none d-md-none d-lg-block " href="FormularioCriarSetor.html">
                                <i class="fas fa-plus"></i>  Novo Setor
                                </a>
                             <a class="btn btn-primary col-md-2 col-2 cliente2 d-block d-sm-block d-md-block d-lg-none" href="FormularioCriarSetor.html">
                ...
                <table class="table table-striped table-hover table-condensed table-row">
                    ...
                    <tbody>
                        <tr class="row">
                            <th class="col-sm-2 col-2 col-md-2">1</th>
                            <td class="col-sm-4 col-8 col-md-6">Mark</td>
                            <td class="col-sm-6 col-8 col-md-4">
                                ...
                                <a class="btn btn-warning btn-sm" href="FormularioEditarSetor.html">Editar</a>
                        ...
                        <tr class="row">
                            <th class="col-sm-2 col-2 col-md-2">2</th>
                            <td class="col-sm-4 col-8 col-md-6">Jacob</td>
                        ...
                        <tr class="row">
                            <th class="col-sm-2 col-2 col-md-2">3</th>
                            <td class="col-sm-4 col-8 col-md-6">Larry</td>
                        ...
                        <tr class="row">
                            <th class="col-sm-2 col-2 col-md-2">4</th>
                            <td class="col-sm-4 col-8 col-md-6">Bob</td>
