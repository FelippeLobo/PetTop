...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="../CrudSetor/layout/assets/bootstrap-4.3.1-dist/css/bootstrap.min.css">
    <!-- Our Custom CSS -->
    <link rel="stylesheet" href="../CrudSetor/layout/assets/css/styles.css" type="text/css">
    <script src="../CrudSetor/views/Style.js"></script>
